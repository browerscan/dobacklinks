...
const ProductMDXComponents: MDXComponentsProps = {
  h1: (props) => <Heading level={1} className="text-2xl font-bold mt-8 mb-6" {...props} />,
  h2: (props) => (
    <Heading
      level={2}
      className="text-2xl font-semibold mt-8 mb-6 border-b-2 border-gray-200 pb-2"
      {...props}
    />
  ),
  h3: (props) => <Heading level={3} className="text-xl font-semibold mt-6 mb-4" {...props} />,
...
export default ProductMDXComponents;
