...
ALTER TABLE "orders" ADD CONSTRAINT "orders_submitted_product_id_products_id_fk" FOREIGN KEY ("submitted_product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
